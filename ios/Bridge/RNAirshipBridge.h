...
- (void)featureFlagManagerStatusWithCompletionHandler:(void (^ _Nonnull)(NSString * _Nullable, NSError * _Nullable))completionHandler NS_SWIFT_NAME(featureFlagManagerStatus()) NS_SWIFT_ASYNC_NAME(featureFlagManagerStatus());
- (void)featureFlagManagerWaitRefreshWithMaxTimeMillis:(NSNumber * _Nullable)maxTimeMillis completionHandler:(void (^ _Nonnull)(NSError * _Nullable))completionHandler NS_SWIFT_NAME(featureFlagManagerWaitRefresh(maxTimeMillis:)) NS_SWIFT_ASYNC_NAME(featureFlagManagerWaitRefresh(maxTimeMillis:));
