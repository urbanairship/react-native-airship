...
#import "RTNAirshipPreferenceCenterView.h"
...
@interface RTNAirshipPreferenceCenterView()<RTNAirshipPreferenceCenterWebViewWrapperDelegate>
@property (nonatomic, strong) RTNAirshipPreferenceCenterWebViewWrapper *wrapper;
@end
...
- (void)setPreferenceCenterID:(NSString *)preferenceCenterID {
    _preferenceCenterID = preferenceCenterID;
    // TODO
}
